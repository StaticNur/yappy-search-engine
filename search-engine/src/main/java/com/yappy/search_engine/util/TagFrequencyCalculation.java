...
public class TagFrequencyCalculation {

    public static Map<String, Integer> getMapTag(List<VideoFromExcel> videos) {
    ...
    public static List<String> extractTags(String text) {
        ...
        Pattern pattern = Pattern.compile("#[\\wА-ЯЁа-яё]+", Pattern.CASE_INSENSITIVE);
